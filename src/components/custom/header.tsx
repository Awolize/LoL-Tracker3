import { DifferentHeaderCounter } from "@/components/custom/header-counter";
import { SwitchWithLabel } from "@/components/custom/switch-with-label";
import { ToggleEye } from "@/components/custom/toggle-eye";
...
export default function Header({
	...
	const filteredCount = champions.filter((c) =>
