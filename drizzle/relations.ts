...
import { match, matchInfo, summoner, challenges, championMastery, challengesConfig, challengeLocalization, challengesDetails, totalPoints, preferences, challenge, categoryPoints, matchSummoners, challengeHeroes, championDetails, challengesChampionOcean, challengesAdaptToAllSituations, challengesInvincible, challengesChampionOcean2024Split3 } from "./schema";
...
export const challengesAdaptToAllSituationsRelations = relations(challengesAdaptToAllSituations, ({one}) => ({
	challenge: one(challenges, {
...
export const challengesChampionOcean2024Split3Relations = relations(challengesChampionOcean2024Split3, ({one}) => ({
	challenge: one(challenges, {
