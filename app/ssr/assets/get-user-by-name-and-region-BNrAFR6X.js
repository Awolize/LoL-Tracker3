import { j as jsxRuntimeExports, h as React2, r as reactExports, k as React, f as commonjsGlobal, g as getDefaultExportFromCjs, c as createServerFn, d as createServerRpc, u as useRouter } from "../server.js";
import { h as createLucideIcon, i as filteredOut, j as clsx, k as createSlot, r as reactDomExports, l as cn, u as useComposedRefs, m as useFloating, o as offset, s as shift, n as flip, p as size, q as arrow, t as hide, v as limitShift, w as autoUpdate, x as ReactDOM, y as composeRefs, B as Button, z as sortAlgorithm, A as useParams, L as Link, g as getSummonerByUsernameRateLimit } from "./get-summoner-by-username-rate-limit-DUX4FPAh.js";
import { d as db, c as championMastery, e as eq, b as constantsExports, f as riotApi, g as championDetails, h as and, i as ilike, n as notInArray, s as summoner, j as inArray } from "./riot-api-DL3qE7bV.js";
...
const useDataDragonPath = (version) => {
...
const ChampionItem = ({
  ...
  const hide2 = disabled && !showFinished;
  const { getChampionImage } = useDataDragonPath(champ.version);
  console.log(getChampionImage(champ.full));
  if (hide2) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return (
      ...
      "li",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10", children: [
            showLevel && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute top-1 left-1 flex h-5 w-5 items-center justify-center rounded-full bg-gray-900 bg-opacity-50 font-bold text-xs", children: champ.championLevel }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center text-xs", children: champ.name }),
          showMasteryPoints && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "items-center justify-center text-center text-xs", children: champ.championPoints })
        ]
      },
      champ.key
    )
...
const DifferentHeaderCounter = ({ finished, total, version }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "relative mt-2 flex w-full justify-center", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-52 min-w-fit", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-xl bg-linear-to-r from-green-500 via-sky-500 to-purple-500 p-[3px]", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col justify-between rounded-lg bg-background px-4 py-2 text-center text-foreground ", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm", children: [
        (100 * finished / total).toFixed(2),
        " %"
      ] })
    ] }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "fixed top-1 right-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-gray-400", children: [
      "V",
      version
    ] }) })
  ] });
...
const SwitchWithLabel = ({ label, checked, onChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { htmlFor: `switchWLabel${label}`, children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Switch,
      {
...
const ToggleEye = ({ label, checked, onChange }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center gap-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Switch$1, { id: "toggle-eye", checked, onCheckedChange: onChange, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      "span",
      {
        className: "h-full w-full transform content-center items-center justify-center transition",
        children: checked ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "svg",
          {
            ...
            className: "h-6 w-6",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Eye Open" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
                  strokeLinecap: "round",
          ...
          "svg",
          {
            ...
            className: "h-6 w-6",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("title", { children: "Eye Closed" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "path",
                {
                  strokeLinecap: "round",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Label$2, { htmlFor: "toggle-eye", className: "sr-only", children: label })
  ] });
};
const useMatchHistoryStore = create()((set) => ({
...
const createUserStore = (initProps) => {
...
function UserProvider({ children, ...props }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(UserContext.Provider, { value: storeRef.current, children });
}
function useUserContext(selector) {
  const store = reactExports.useContext(UserContext);
...
function Dropdown({ choices, choice, callback, menuLabel }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { className: "w-auto", children: [
      menuLabel && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { children: menuLabel }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        DropdownMenuRadioGroup,
        {
          ...
          children: choices.map((choice2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            DropdownMenuRadioItem,
            {
              value: choice2.value.toString(),
              children: choice2.text
            },
...
const masteryBySummoner = async (region, user) => {
  try {
    const masteryRows = await db.select({
      mastery: championMastery
    }).from(championMastery).where(eq(championMastery.puuid, user.puuid));
...
const Akali = "Mid";
const Akshan = "Mid";
const Alistar = "Support";
const Amumu = "Jungle";
const Anivia = "Mid";
const Annie = "Mid";
const Aphelios = "Bottom";
const Ashe = "Bottom";
const AurelionSol = "Mid";
const Aurora = "Mid";
const Azir = "Mid";
const Bard = "Support";
const Belveth = "Jungle";
const Blitzcrank = "Support";
const Brand = "Jungle";
const Braum = "Support";
const Briar = "Jungle";
const Caitlyn = "Bottom";
const Camille = "Top";
const Cassiopeia = "Mid";
const Chogath = "Top";
const Corki = "Mid";
const Darius = "Top";
const Diana = "Jungle";
...
const Ekko = "Jungle";
const Elise = "Jungle";
const Evelynn = "Jungle";
const Ezreal = "Bottom";
const Fiddlesticks = "Jungle";
const Fiora = "Top";
const Fizz = "Mid";
const Galio = "Mid";
const Gangplank = "Top";
...
const Graves = "Jungle";
const Gwen = "Top";
const Hecarim = "Jungle";
const Heimerdinger = "Support";
const Hwei = "Mid";
const Illaoi = "Top";
const Irelia = "Top";
const Ivern = "Jungle";
const Janna = "Support";
const JarvanIV = "Jungle";
const Jax = "Top";
const Jayce = "Top";
const Jhin = "Bottom";
const Jinx = "Bottom";
const Kaisa = "Bottom";
const Kalista = "Bottom";
const Karma = "Support";
const Karthus = "Jungle";
const Kassadin = "Mid";
const Katarina = "Mid";
const Kayle = "Top";
const Kayn = "Jungle";
...
const Malphite = "Top";
const Malzahar = "Mid";
const Maokai = "Support";
const MasterYi = "Jungle";
const Milio = "Support";
const MissFortune = "Bottom";
const MonkeyKing = "Jungle";
const Mordekaiser = "Jungle";
const Morgana = "Support";
const Naafiri = "Mid";
const Nami = "Support";
const Nasus = "Top";
const Nautilus = "Support";
const Neeko = "Mid";
const Nidalee = "Jungle";
const Nilah = "Bottom";
const Nocturne = "Jungle";
const Nunu = "Jungle";
const Olaf = "Top";
const Orianna = "Mid";
const Ornn = "Top";
const Pantheon = "Support";
const Poppy = "Jungle";
const Pyke = "Support";
const Qiyana = "Mid";
const Quinn = "Top";
...
const Ryze = "Mid";
const Samira = "Bottom";
const Sejuani = "Jungle";
const Senna = "Support";
const Seraphine = "Support";
const Sett = "Top";
const Shaco = "Jungle";
const Shen = "Top";
const Shyvana = "Jungle";
const Singed = "Top";
const Sion = "Top";
const Sivir = "Bottom";
const Skarner = "Jungle";
const Sona = "Support";
const Soraka = "Support";
const Swain = "Support";
const Sylas = "Mid";
const Syndra = "Mid";
const TahmKench = "Top";
const Taliyah = "Jungle";
const Talon = "Mid";
const Taric = "Support";
const Teemo = "Top";
const Thresh = "Support";
const Tristana = "Bottom";
const Trundle = "Top";
const Tryndamere = "Top";
const TwistedFate = "Mid";
const Twitch = "Bottom";
const Udyr = "Jungle";
const Urgot = "Top";
const Varus = "Bottom";
const Vayne = "Bottom";
const Veigar = "Mid";
const Velkoz = "Support";
const Vex = "Mid";
const Vi = "Jungle";
const Viego = "Jungle";
const Viktor = "Mid";
const Vladimir = "Mid";
const Volibear = "Jungle";
const Warwick = "Jungle";
const Xayah = "Bottom";
const Xerath = "Support";
const XinZhao = "Jungle";
const Yasuo = "Mid";
const Yone = "Mid";
const Yorick = "Top";
const Yuumi = "Support";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Button,
      {
        variant: "secondary",
        size: "sm",
        className: `${!isUpdating ? "bg-linear-to-r from-indigo-500 to-purple-500" : "w-16 bg-linear-to-r from-purple-500 to-indigo-500"} relative my-2 inline-flex w-24 items-center justify-center rounded px-3 py-1`,
        onClick: updateUser,
        disabled: isUpdating,
        children: isUpdating ? "Updating..." : "Update"
      }
    ),
    success && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-green-500 text-xs mt-1", children: "Update complete!" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-red-500 text-xs mt-1", children: error })
  ] });
};
...
var SortOrder2 = /* @__PURE__ */ ((SortOrder22) => {
  SortOrder22[SortOrder22["Points"] = 0] = "Points";
  SortOrder22[SortOrder22["AZ"] = 1] = "AZ";
  SortOrder22[SortOrder22["Level"] = 2] = "Level";
  return SortOrder22;
})(SortOrder2 || {});
function Header({
  champions
  ...
  const filteredChoices = [
    { text: "100", value: 100 },
    { text: "500", value: 500 },
    { text: "1,000", value: 1e3 },
    { text: "1,800 (Level 2)", value: 1800 },
    { text: "5,000", value: 5e3 },
    { text: "6000 (Level 3)", value: 6e3 },
    { text: "10,000", value: 1e4 },
    { text: "12,600 (Level 4)", value: 12600 },
    { text: "21,600 (Level 5)", value: 21600 },
    { text: "50,000", value: 5e4 },
    { text: "100,000", value: 1e5 },
    {
      text: "All",
  ...
  const filteredCount = visibleChampions.filter(
    (c) => filteredOut(c, filterPoints)
  ).length;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex w-full items-center justify-between px-4 py-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row items-center justify-center gap-4 mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FullSummonerUpdate, { user }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-px bg-gray-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SwitchWithLabel,
        {
          label: "By role",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-[1px] bg-gray-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SwitchWithLabel,
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { children: "Image size" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScaleSlider, {})
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-[1px] bg-gray-500" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-1 justify-end" })
  ] });
}
const initialState = {
  ...
  selectedChampions: /* @__PURE__ */ new Set(),
  championsScale: 85,
  sortOrder: SortOrder2.Points,
  showSelectedChampions: false
};
const useOptionsPersistentStore = (persistName) => {
  console.log(persistName);
  return create()(
    persist(
      (set) => ({
        ...initialState,
        toggleMasteryPoints: () => set((state) => ({
          ...state,
        ...
        toggleShowSelectedChampions: () => set((state) => ({
          ...state,
        ...
        toggleSelectedChampion: (championId) => set((state) => {
          state.selectedChampions.has(championId) ? state.selectedChampions.delete(championId) : state.selectedChampions.add(championId);
          return { ...state };
        }),
...
const OptionsContext = reactExports.createContext(null);
function OptionsProvider({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(OptionsContext.Provider, { value: storeRef.current, children });
}
function useOptionsPersistentContext(selector) {
  const store = reactExports.useContext(OptionsContext);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full p-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: champions.sort((a, b) => sortAlgorithm(sortOrder, a, b)).map((championInfo) => {
          ...
          return /* @__PURE__ */ jsxRuntimeExports.jsx(
            ChampionItem,
            {
              ...
              showFinished: false,
              showMasteryPoints,
              handleChampionClick: () => showSelectedChampions && toggleSelectedChampion(championInfo.id)
            },
            championInfo.id
          );
        })
...
const MatchTable = ({
  ...
  const user = useUserContext((s) => s.user);
  const { region } = useParams({ from: "/$region/$username/" });
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "relative overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-left text-gray-500 text-sm rtl:text-right dark:text-gray-400", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-gray-50 text-gray-700 text-xs uppercase dark:bg-gray-700 dark:text-gray-400", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", className: "px-2 py-2", children: "Champion" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", className: "px-2 py-2", children: "Player" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("th", { scope: "col", className: "px-2 py-2", children: "K/D/A" })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: players.filter((player) => player.teamId === teamId).map((player) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "tr",
      {
        className: user.puuid === player.puuid ? "border-b bg-gray-50 dark:border-gray-700 dark:bg-gray-700" : "border-b bg-white dark:border-gray-700 dark:bg-gray-800",
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "flex min-w-24 flex-col justify-center gap-1 whitespace-nowrap px-2 py-2 font-medium text-gray-900 dark:text-foreground", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center", children: player.championName })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "min-w-48 whitespace-nowrap px-2 py-2 font-medium text-gray-900 dark:text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              ...
              children: player.riotIdGameName
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("td", { className: "min-w-24 whitespace-nowrap px-4 py-2 font-medium text-gray-900 dark:text-foreground", children: [
            player.kills,
            "/",
            player.deaths,
            "/",
...
const MatchItem = ({ match }) => {
  const user = useUserContext((s) => s.user);
  const isWin = match.MatchInfo.participants?.find((p) => p.puuid === user.puuid).win;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row gap-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: match.MatchInfo.gameStartTimestamp.toLocaleString() }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: isWin ? "Win ✅" : "Lose ❌" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        (match.MatchInfo.gameDuration / 60).toPrecision(3),
        " min"
      ] })
    ] }),
    " "
...
const MatchHistory = ({ matches }) => {
  ...
  if (!matches.length)
    return /* @__PURE__ */ jsxRuntimeExports.jsx(
      Sheet,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetContent, { className: "flex w-[1100px] flex-col sm:max-w-none", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-center", children: "Match history" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetDescription, { className: "text-center", children: [
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Sheet,
    {
      open: showMatchHistory,
      onOpenChange: (open) => setShowMatchHistory(open),
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { className: "flex w-[1100px] flex-col sm:max-w-none", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetHeader, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { className: "text-center", children: "Match history" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetDescription, { className: "text-center", children: "Remember to click the update button to receive the latest list of matches." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ScrollArea, { className: "rounded-md border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-6 p-4", children: matches.map((match) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsx(MatchItem, { match }, match.gameId);
        }) }) })
      ] })
    }
  );
...
function RoleHeader({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-row justify-evenly align-bottom text-md", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "my-auto p-2", children: [
      finishedSize,
      " / ",
      size2,
      hasHidden ? "*" : ""
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mb-2 bg-linear-to-r from-green-600 via-sky-600 to-purple-600 pb-[3px]", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex h-full flex-col justify-between bg-background text-foreground", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-bold text-xl", children: role }) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h4", { className: "my-auto p-2", children: [
...
const SortedChampionList = ({
  ...
  const playerChampionInfoSorted = [];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-row gap-2", children: playerChampionInfoSorted.map((roleChampions, index) => {
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full p-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          children: roleChampions.map((championInfo) => {
            const hidden = selectedChampions.has(championInfo.id);
            if (hidden && !showSelectedChampions) {
              return null;
            }
...
async function getCompleteChampionData(region, user) {
...
async function getMatches(user, take = 9999999) {
  return [];
}
async function getUserByNameAndRegion(username, region) {
  function isWithinThreshold(date) {
    const oneDayInMillis = 24 * 60 * 60 * 1e3;
    return (/* @__PURE__ */ new Date()).getTime() - date.getTime() <= oneDayInMillis;
  }
  ...
  try {
    ...
    const { summoner: riotSummoner, account } = await getSummonerByUsernameRateLimit(username, region);
    ...
    if (existingUsers.length > 0) {
      await db.update(summoner).set({ gameName: null, tagLine: null }).where(
        inArray(
          summoner.puuid,
...
export {
  ...
  Header as H,
  MatchHistory as M,
  OptionsProvider as O,
  SortedChampionList as S,
  UserProvider as U,
  getCompleteChampionData as a,
  getMatches as b,
  getUserByNameAndRegion as g,
  useOptionsPersistentContext as u
};
