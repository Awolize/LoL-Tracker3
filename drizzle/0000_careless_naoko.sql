...
CREATE UNIQUE INDEX "ChampionMastery_championId_puuid_key" ON "ChampionMastery" USING btree ("championId" int4_ops,"puuid" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "ChallengeLocalization_id_language_key" ON "ChallengeLocalization" USING btree ("id" int4_ops,"language" int4_ops);--> statement-breakpoint
CREATE UNIQUE INDEX "TotalPoints_challengesDetailsId_key" ON "TotalPoints" USING btree ("challengesDetailsId" text_ops);--> statement-breakpoint
...
CREATE UNIQUE INDEX "Challenge_challengeId_challengesDetailsId_key" ON "Challenge" USING btree ("challengeId" int4_ops,"challengesDetailsId" int4_ops);--> statement-breakpoint
...
CREATE INDEX "_ChallengesChampionOcean2024Split3_B_index" ON "_ChallengesChampionOcean2024Split3" USING btree ("B" int4_ops);
*/