import type { ChampionDetails } from "@/lib/types";
import type { CompleteChampionInfo } from "@/lib/types";
import { DifferentChampionItem } from "@/components/custom/different-champion-item";
import { DifferentRoleHeader } from "@/components/custom/different-role-header";
...
export function RoleChampionList({
	...
	const selectedChallenge = useChallengeContext((state) => state.selectedChallengeId) ?? propSelectedChallenge ?? null;
